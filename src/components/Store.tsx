  ...
  const products = [
    {
      ...
      price: "$ 159",
      type: "AI_STUDIO",
      demoUrl: "https://komikforge-596709003709.asia-southeast1.run.app",
    },
    {
      id: 2,
      title: "NARRATA AI",
    ...
    },
    {
      ...
      title: "Conan-STUDIO",
      category: "AI Application",
      description: "Platform kreasi video dan aset digital terdepan dari Conan AI.",
      price: "Pengembangan",
      type: "AI_STUDIO",
      demoUrl: "https://conan-studio-596709003709.us-west1.run.app",
    },
    {
      id: 12,
      title: "ORCHESTRA AI",
      category: "AI Application",
      description: "Manajemen dan Orkestrasi AI Workspace secara komprehensif.",
      price: "Pengembangan",
      type: "AI_STUDIO",
      demoUrl: "https://design-orchestra-ai-596709003709.asia-southeast1.run.app",
    },
    {
      id: 13,
      title: "E LEARNING",
    ...
    },
    {
      ...
      title: "OMNILITE DUO",
      category: "AI Application",
      description: "Versi ringan dari Omnilite Pro untuk operasional UKM.",
      price: "$ 129",
      type: "AI_STUDIO",
      demoUrl: "https://omnilite-duo-548004788759.asia-southeast1.run.app",
    },
    {
      id: 15,
      title: "VIDMANGA AI",
      category: "AI Application",
      description: "Sistem konversi gambar manga ke motion graphic otomatis.",
      price: "$ 199",
      type: "AI_STUDIO",
      demoUrl: "",
    }
